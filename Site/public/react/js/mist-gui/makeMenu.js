...
export default function init(functions, layers, makeFunctionGroup, makeValueGroup, values) {
  ...
  return {
    ...
    funNames: funNames,
    functionsArrows: functionsArrows,
    functionsButton: functionsButton,
    functionsButtonBox: functionsButtonBox,
    functionsButtonRect: functionsButtonRect,
    functionsButtonText: functionsButtonText,
    ...
    valNames: valNames,
    valuesArrows: valuesArrows,
    valuesButton: valuesButton,
    valuesButtonBox: valuesButtonBox,
    valuesButtonRect: valuesButtonRect,
